...
class _GameSecret_0 {
  ...
  fromValue(value_0) {
    return {
      culprit: _descriptor_0.fromValue(value_0),
      salt: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.culprit).concat(_descriptor_1.toValue(value_0.salt));
  }
}

const _descriptor_5 = new _GameSecret_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      create_game: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('create_game',
                                     ...
                                     'guess_who.compact line 32 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      submit_guess: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`submit_guess: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const game_id_0 = args_1[1];
        const guess_id_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submit_guess',
                                     'argument 1 (as invoked from Typescript)',
                                     'guess_who.compact line 53 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(game_id_0).concat(_descriptor_0.toValue(guess_id_0)),
  ...
  _culprit_id_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('culprit_id',
                                 'return value',
                                 'guess_who.compact line 24 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
  ...
  _salt_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('salt',
                                 'return value',
                                 'guess_who.compact line 25 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _create_game_0(context, partialProofData) {
    ...
    const commitment_0 = this._persistentHash_0({ culprit: secret_0,
                                                  salt: secret_salt_0 });
  ...
  _submit_guess_0(context, partialProofData, game_id_0, guess_id_0) {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'guess_who.compact line 20 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
